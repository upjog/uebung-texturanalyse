...
image_path = '../images/poolraum_bsp_small.jpg'                      # Bildimport Linux
#image_path = './images/poolraum_bsp_small.jpg'                       # Bildimport Windows
image = cv2.imread(image_path, cv2.IMREAD_GRAYSCALE)

out_path = '../out/poolraum_bsp/'   # Linux
#out_path = './out/poolraum_bsp'     # Windows
...
# Versuche Jans automatische Anpassung
